...
import com.projectinspire.activities.GoogleMapObjectActivity;
import com.projectinspire.utilities.JSONParser;
			...
			try {
				...
				if(placesDetails!=null)
				{
	                ...
	                for (int i = 0; i < results.length(); i++) {
	                    ...
	                    // Debugging
	                    Log.d("Lat: ", loc.getString(TAG_LAT));
	                    Log.d("lng: ", loc.getString(TAG_LNG));
	                    
	                    // Debugging
	                    //Log.d("float Lat: ", String.valueOf(Float.valueOf(loc.getString(TAG_LAT))));
	                    //Log.d("float lng: ", String.valueOf(Float.valueOf(loc.getString(TAG_LNG))));
